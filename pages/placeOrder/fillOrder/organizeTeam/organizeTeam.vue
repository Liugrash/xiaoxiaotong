<template>
    <view class="content">
		<view class="box">
			...
			<span class="words" style="width: 200px;">组队信息填写</span>
		</view>
       ...
       <u-form :model="form" ref="uForm">
       	...
       	<u-form-item label="地址" prop="address">
       		<u-input v-model="form.address" placeholder="请输入队伍地址"/>
       	</u-form-item>
       	<u-form-item label="组队时间" prop="arrive_date">
       		<u-input v-model="form.arrive_date" placeholder="请输入组队时间"/>
       	</u-form-item>
