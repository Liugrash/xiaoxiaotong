<template>
    <view class="content">
		<view class="box">
			...
			<span class="words" style="width: 200px;">学习辅导信息填写</span>
		</view>
       ...
       <u-form :model="form" ref="uForm">
       	...
       	<u-form-item label="地址" prop="address">
       		<u-input v-model="form.address" placeholder="请输入辅导地址"/>
       	</u-form-item>
       	<u-form-item label="辅导时间" prop="arrive_date">
       		<u-input v-model="form.arrive_date" placeholder="请输入辅导时间"/>
       	</u-form-item>
       	<u-form-item label="提供报酬" prop="pay">
       		<u-input v-model="form.pay" placeholder="请输入辅导报酬"/>
       	</u-form-item>
